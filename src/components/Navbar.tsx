...
export const Navbar: React.FC = () => {
  ...
  const links = [
    ...
    { to: '/profile', label: 'My Mission', icon: Target },
    { to: '/guess', label: 'Guess Tasks', icon: Search },
  ];
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex w-full md:w-auto justify-around md:justify-end items-center md:space-x-8">
            {links.map((link) => {
              ...
              return (
                <Link
                  ...
                  to={link.to}
                  className={cn(
                    'flex flex-col md:flex-row items-center justify-center md:space-x-2 w-full md:w-auto py-2 px-1 text-sm font-medium transition-colors duration-200',
                    isActive
            ...
            <button
              ...
              className="flex flex-col md:flex-row items-center justify-center md:space-x-2 w-full md:w-auto py-2 px-1 text-sm font-medium text-slate-500 hover:text-red-500 transition-colors duration-200"
            >
              <LogOut className="w-5 h-5 md:w-4 md:h-4 mb-1 md:mb-0" />
